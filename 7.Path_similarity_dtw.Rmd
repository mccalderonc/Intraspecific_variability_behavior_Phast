...
# compute DTW distance for each pair of individuals
  dtw_distances <- mapply(function(ind1, ind2) {
    dtw_result <- dtw(indiv_splits[[ind1]][, c("coords.x1", "coords.x2")],
                      ...
                      keep.internals = TRUE)
    dtw_result$distance  # extracting the DTWstep.pattern = dtw_result$distance  # extracting the DTW distance
...
ggsave(file="~/ownCloud/PhDLife/P.hastatus/Thesis/Paper2/PlosOne/figures/Fig3_option2.pdf", width=15, height=12)
```
